...
data class English(
    ...
    override val invId: String = "INV ID",
    override val invNumber: String= "INV NO",
    override val invType: String = "INV NO",
    override val invDate: String = "INV Date",
    override val postedDate: String = "Post Date",
    override val custId: String = "Cust_ID",
    override val firstName: String = "Firstname",
    override val cashierId: String = "Cashier_Id",
    override val cashierName: String = "Cashier_Name",
    override val amt: String = "AMT",
